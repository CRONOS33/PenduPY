...
def creation_main_window():
    ...
    mot_courrent=tk.Label(main_window,text = "test")
    mot_courrent.place(x=700,y=100)

    lettre_utilises=tk.Label(main_window,text = "test")
    lettre_utilises.place(x=700,y=200)
